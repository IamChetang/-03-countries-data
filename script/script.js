...
xValues.forEach((element, index) => {
  let populationFiltered = countries.filter(function (e) {
    return e.population === xValues[index];
  });
  ...
  <li class="bar" >
  <div  style="width:${width}rem;height:1.5rem;background-color:#f19e0e; display:flex; justify-content:flex-start; align-items:center "></div>
  </li>
...
langValues.forEach((value, index) => {
  value.forEach((value) => {
...
topLanguages.forEach((element, index) => {
  ...
  <li class="bar" >
  <div  style="width:${element[1]}%;height:1.5rem;background-color:#f19e0e; display:flex; justify-content:flex-start; align-items:center "></div>
  </li>
